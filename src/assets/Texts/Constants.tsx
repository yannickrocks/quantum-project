...
const HomePageText2 =
  "You already have everything you need to complete your journey, using the tools you have at your disposal. Completing the Outer Wilds isn’t required for this experience, but said experience will be directly enriched if you have, and we really recommend it. This site's HTML code may contain the answers you need by necessity, but progression of that sort would rob you of the lessons you learn along the way.";
const HomePageText3 =
...
const HomePageText4 = "Clocks’ ticking, hatchling. Good Luck.";
